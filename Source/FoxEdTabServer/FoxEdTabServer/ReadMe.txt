========================================================================
    KONSOLENANWENDUNG: FoxEdTabServer-Projektübersicht
========================================================================

Diese FoxEdTabServer-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre FoxEdTabServer-Anwendung besteht.


FoxEdTabServer.vcxproj
...
FoxEdTabServer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen FoxEdTabServer.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
